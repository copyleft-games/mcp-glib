* mcp-glib
A GLib/GObject implementation of the [[https://modelcontextprotocol.io/][Model Context Protocol (MCP)]] for building MCP servers and clients in C.
...
See [[file:docs/building.org#cross-compilation][docs/building.org]] for details.
...
See [[file:docs/cli-tools.org]] for complete documentation.
...
** Documentation
See [[file:docs/]] for detailed documentation:

- [[file:docs/building.org][Building]] - Build instructions and dependencies
- [[file:docs/server-guide.org][Server Guide]] - How to create MCP servers
- [[file:docs/client-guide.org][Client Guide]] - How to create MCP clients
- [[file:docs/cli-tools.org][CLI Tools]] - Command-line tools for MCP servers
- [[file:docs/api-reference.org][API Reference]] - Complete API documentation

** References
- [[https://spec.modelcontextprotocol.io/][MCP Specification]]
- [[https://www.jsonrpc.org/specification][JSON-RPC 2.0 Specification]]
- [[https://docs.gtk.org/gobject/][GObject Manual]]
- [[https://gnome.pages.gitlab.gnome.org/libdex/][libdex Documentation]]
